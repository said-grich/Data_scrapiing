...
def options():
    """ Parse arguments
    """
    ap = argparse.ArgumentParser(prog="Data_scraping",
    ...
    ap.add_argument("--min-wait-time", type=float, default=15,
                    help="specifiy a minimum wait time in case of scraping limit error. This value will be adjusted by Data_scraping if the value provided does not satisfy the limits constraints")
    args = ap.parse_args()
